...
which(abs(mat_cor)<1 & abs(mat_cor)>=0.6) 
n=10000
m=2931
train=punteggi[1:n,]
test=punteggi[(n+1):(n+m),] 

cor(train$`Miss Congeniality`,train$`Lord of the Rings: The Fellowship of the Ring`)
cor(train$`Miss Congeniality`,train$`Lord of the Rings: The Return of the King`)
cor(train$`Miss Congeniality`,train$`Lord of the Rings: The Two Towers`)
cor(train$`Miss Congeniality`,train$`Kill Bill: Vol. 1`)
cor(train$`Miss Congeniality`,train$`Kill Bill: Vol. 2`)
